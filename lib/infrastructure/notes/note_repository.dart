...
import 'package:notes_app/infrastructure/core/firestore_helpers.dart';
...
class NoteRepository implements INoteRepository {
  ...
  Future<Either<NoteFailure, Unit>> create(Note note) async {
    try {
      ...
      userDoc.noteCollection.document(noteDto.id).setData(
            noteDto.toJson(),
          );
      return right(unit);
  ...
  Future<Either<NoteFailure, Unit>> delete(Note note) async {
    try {
      ...
      userDoc.noteCollection.document(noteId).delete();
      return right(unit);
    } on PlatformException catch (e) {
      if (e.message.contains("PERMISSION_DENIED")) {
        return left(const NoteFailure.insufficientPermission());
  ...
  Future<Either<NoteFailure, Unit>> update(Note note) async {
    try {
      ...
      userDoc.noteCollection.document(noteDto.id).updateData(
            noteDto.toJson(),
          );
      return right(unit);
    } on PlatformException catch (e) {
